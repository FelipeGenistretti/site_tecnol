<div class="container-x bg-[#004A65] py-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div>
            <div class="text-white space-y-8">
                ...
                <div>
                    <button type="button" class="textContainer flex items-center p-3 border border-white rounded-md gap-2 uppercase max-sm:w-full max-sm:justify-center">
