<div class="container-x bg-contrast bg-bgSecondary py-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">

        <div>
            <img src="/imgSolictaTitular.png" alt="" class="flex justify-center h-full">
        </div>
        ...
        <div>
            <div class="text-textPrimary space-y-5 text-contrast">
                ...
                <div>
                    <button type="button" class="button-contrast textContainer border border-black bts-hover text-textPrimary  flex items-center p-3  rounded-md gap-2 uppercase max-sm:w-full max-sm:justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-contrast">
                            ...
                            <path d="M15.5 12.5C16.0523 12.5 16.5 12.9477 16.5 13.5C16.5 14.0523 16.0523 14.5 15.5 14.5H7.5C6.94772 14.5 6.5 14.0523 6.5 13.5C6.5 12.9477 6.94772 12.5 7.5 12.5H15.5Z" fill="currentColor"/>
                            <path d="M12.5 16.5C13.0523 16.5 13.5 16.9477 13.5 17.5C13.5 18.0523 13.0523 18.5 12.5 18.5H7.5C6.94772 18.5 6.5 18.0523 6.5 17.5C6.5 16.9477 6.94772 16.5 7.5 16.5H12.5Z" fill="currentColor"/>
                            <path d="M17.6543 14.6339C18.5955 13.76 20.0772 13.8552 20.8994 14.8419C21.6631 15.7584 21.5749 17.1127 20.6982 17.9219L16.5293 21.7696C16.4126 21.8774 16.279 21.9658 16.1338 22.0303L14.2422 22.8712C13.0877 23.3843 11.8731 22.2816 12.2725 21.0831L12.8555 19.3331C12.9326 19.1017 13.0674 18.8935 13.2461 18.7276L17.6543 14.6339ZM14.0938 19.6407C14.0683 19.6643 14.0491 19.6938 14.0381 19.7266L13.4551 21.4766C13.398 21.6479 13.5714 21.8058 13.7363 21.7325L15.6279 20.8917C15.6486 20.8825 15.668 20.8699 15.6846 20.8546L18.5244 18.2315L17.1211 16.8282L14.0938 19.6407ZM19.9424 15.6387C19.5774 15.201 18.9196 15.1592 18.502 15.5469L17.8545 16.1475L19.2598 17.5528L19.8525 17.0059C20.2417 16.6467 20.2814 16.0455 19.9424 15.6387Z" fill="currentColor"/>
                        </svg>



                        <p>solicitação do titular</p>
                    </button>
                </div>
            </div>
        </div>
