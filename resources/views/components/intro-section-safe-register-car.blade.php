<div>
  ...
  <div class="container-x py-10">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
      ...
      <div>
        <div class="mb-8">
          <h1 class="text-5xl mb-4">Os impactos positivos do nosso sistema.</h1>
          <p class="mb-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <!-- Card 1 -->
          <div class="p-5 rounded-md flex items-center gap-2 bg-[#F8F9FA] shadow-md transition transform hover:scale-105 duration-300 hover:shadow-lg">
