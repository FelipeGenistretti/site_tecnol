      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-5 text-textPrimary">
          ...
          <div class="lg:p-5 max-sm:p-3 rounded-md flex items-center gap-3 bg-contrast text-contrast bg-[#F8F9FA] shadow-md transition transform hover:scale-105 duration-300 hover:shadow-lg">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-contrast">
              <g clip-path="url(#clip0_825_8019)">
              <path d="M10 5V10L13.3333 11.6667" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M10.0003 18.3334C14.6027 18.3334 18.3337 14.6024 18.3337 10C18.3337 5.39765 14.6027 1.66669 10.0003 1.66669C5.39795 1.66669 1.66699 5.39765 1.66699 10C1.66699 14.6024 5.39795 18.3334 10.0003 18.3334Z" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              </g>
              <defs>
          ...
          <div class="lg:p-5 max-sm:p-3 rounded-md flex items-center gap-2 bg-contrast text-contrast bg-[#F8F9FA] shadow-md transition transform hover:scale-105 duration-300 hover:shadow-lg">
            ...
            <path d="M10.0003 18.3334C14.6027 18.3334 18.3337 14.6024 18.3337 10C18.3337 5.39765 14.6027 1.66669 10.0003 1.66669C5.39795 1.66669 1.66699 5.39765 1.66699 10C1.66699 14.6024 5.39795 18.3334 10.0003 18.3334Z" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M7.5 9.99998L9.16667 11.6666L12.5 8.33331" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
            <defs>
          ...
          <div class="lg:p-5 max-sm:p-3 rounded-md flex items-center gap-2 bg-contrast text-contrast bg-[#F8F9FA] shadow-md transition transform hover:scale-105 duration-300 hover:shadow-lg">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.8333 9.16669H4.16667C3.24619 9.16669 2.5 9.91288 2.5 10.8334V16.6667C2.5 17.5872 3.24619 18.3334 4.16667 18.3334H15.8333C16.7538 18.3334 17.5 17.5872 17.5 16.6667V10.8334C17.5 9.91288 16.7538 9.16669 15.8333 9.16669Z" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M5.83301 9.16669V5.83335C5.83301 4.72828 6.27199 3.66848 7.0534 2.88708C7.8348 2.10567 8.89461 1.66669 9.99967 1.66669C11.1047 1.66669 12.1646 2.10567 12.946 2.88708C13.7274 3.66848 14.1663 4.72828 14.1663 5.83335V9.16669" stroke="#F15A29" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
