    ...
    <ul class="flex flex-col gap-5 p-4 uppercase">
      <li class="relative">
        ...
        <ul class="pl-4 mt-2 hidden submenu flex-col gap-3">
          ...
          <li><a href="{{ route('trabalhe-conosco') }}" class="block hover:text-orange-600">Trabalhe conosco</a></li>
        </ul>
      </li>
      ...
      <li class="relative">
        <button class="w-full flex justify-between items-center hover:text-orange-600 uppercase toggle-submenu">
          Serviços
          <svg class="text-contrast w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path>
          </svg>
        </button>
        <ul class="pl-4 mt-2 hidden submenu flex-col gap-3">
          <li><a href="{{ route('safe-register-car') }}" class="block hover:text-orange-600">Safe Data Analytics - SDA</a></li>
