...
<div class="container-x py-12 gap-3 bg-contrast">
  <div class="grid grid-cols-1 lg:grid-cols-2">
      <div class="space-y-8 text-textPrimary">
        ...
        <p class="textContainer text-contrast text-[16px]">A privacidade e a proteção dos dados pessoais são mandatórias para a Tecnol. Na visita ao nosso site, coletaremos seu nome, e-mail, número de telefone e empresa, se for o caso, quando você fizer a opção de falar com a gente. Na prestação dos serviços de registro pela Tecnol, prevalecerá o disposto nesta Política de Privacidade. Recomendamos consultá-la com regularidade de forma a estar sempre atualizado.</p>
        ...
        <div>
          <button onclick="downloadFile()" type="button" class="justify-center w-full button-secundary-contrast textContainer uppercase border border-black p-3 flex gap-2 items-center rounded-md transform hover:scale-105 duration-300 hover:shadow-md">
      ...
      <div class="max-sm:mt-6 max flex justify-center">
        <img src="/imgPrivacidadeNegociacao.png" alt="">
      </div>
  </div>
</div>
