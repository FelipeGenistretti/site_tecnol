...
<div id="content-real" class="hidden">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 container-x py-10  text-contrast bg-contrast">
        <div class="p-4">
