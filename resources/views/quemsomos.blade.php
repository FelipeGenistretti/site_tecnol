...
<div class="h-[72px] w-[371px] hidden bg-[#E2B203] flex items-center right-10 mt-4 justify-center fixed z-50" id="modalCamposObrigatorios">
  ...
  <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-[16px] text-contrast bg-contrast">
  <!-- Card 1 -->
...
<div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[2fr_auto]  gap-6 container-x mb-12 text-contrast bg-contrast">
...
<form id="enviarCurriculoForm" action="{{ route('enviar-curriculo') }}" enctype="multipart/form-data" accept="image/*,.pdf,.doc,.docx,.xls,.xlsx" method="post" class="text-contrast bg-contrast bg-gray-100 rounded-lg p-6 shadow-md w-full h-full flex flex-col justify-start space-y-4 mt-5">
  ...
  <div class="textContainer grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="flex flex-col">
      ...
      <input type="text" name="nome" class="border rounded px-3 py-2 w-full text-contrast bg-contrast" placeholder="Digite seu nome">
    </div> 
           
    <div class="flex flex-col">
      <label class="textContainer text-sm font-medium mb-1">E-mail</label>
      <input type="text" name="email"  class="border rounded px-3 py-2 w-full text-contrast bg-contrast" placeholder="email@email.com.br">
    </div>
  

    <div class="flex flex-col">
      <label class="textContainer text-sm font-medium mb-1">Telefone</label>
      <input type="text" name="telefone" class="border rounded px-3 py-2 w-full text-contrast bg-contrast" placeholder="(xx) xxxxx-xxxx">
    </div>
    ...
    <div class="flex flex-col text-contrast bg-contrast">
      ...
      <select class="border rounded px-3 py-2 w-full bg-white text-contrast bg-contrast" name="atuacao">
  ...
  <div class="flex flex-col w-full text-contrast bg-contrast">
    ...
    <input type="text" class="border rounded px-3 py-2 w-full pb-12 text-contrast bg-contrast" placeholder="Escreva aqui sua mensagem" name="mensagem" />
  </div>
  ...
  <div class="flex flex-col text-contrast bg-contrast">
    ...
    <label class="text-contrast bg-contrast border rounded px-3 py-2 w-full flex flex-col items-center justify-center cursor-pointer bg-gray-50 hover:bg-gray-100 h-[200px] gap-3">
...
<!-- <input type="hidden" name="recaptcha_token" id="recaptcha_token"> -->
  ...
  <div class="flex flex-col space-y-4 mt-5 text-constrast bg-constrast">
    <div class="bg-gray-100 rounded-lg p-4 shadow-md  flex items-center gap-3  text-contrast bg-contrast">
